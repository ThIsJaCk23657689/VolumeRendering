...
void main() {
    ...
    while (true) {
        ...
        vec4 volume_color = texture(transfer_function, volume_data.a);
         ...
         vec3 temp_color = PhongShading(volume_data.rgb, volume_color.rgb, current_pos);
        ...
        // 實際的位置也改變，相對材質座標也要改變
        current_pos = current_pos + ray_direction * 0.5f;
        ...
        sample_pos = sample_pos + ray_direction_in_texture * 0.5f;
